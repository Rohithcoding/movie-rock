...
import { getLocalMovieById, getLocalTvShowById } from "@/utils/details";
  ...
  try {
    ...
    const media =
      data.mediaType === "movie"
        ? await getLocalMovieById(data.mtmdbId.toString())
        : await getLocalTvShowById(data.mtmdbId.toString());
